...
const skates = [
  { name: "Elite Glide Pro Skates", price: "$650 – $950", desc: "Thermo-formable fit with asymmetrical toe cap for superior power.", status: "In Stock", statusClass: "text-[#006399] bg-[#67bafd]/20 border border-[#67bafd]", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuAntYp1F-aKSRmspn7OoqjNGxVBrkkC2M4VSTmMhXzCnkWIrUwMtazHVkWA1SYC15MVAUbvEYDTz3AKcr-2XT_YExuKErKjoKAr2IV3xGVWV48TNB51NeC2WpComl5xKbGkkonXQy6OoAjysMm6Dg0wOsrPWR_gAI2ahmkVZEiqNjgPekY8HV6__gt7dLPEXH5Bxlt2Egxr8GtnWoaQA2YTjVyKZVVBk-pBhAJmGBOOGkm8k-J4zu8ra5wnUC4BIBaMkmjOOOXmDg" },
  { name: "Strides Speed Skates", price: "$450 – $580", desc: "Ultra-lightweight chassis for maximum agility and breakaway speed.", status: "Limited Qty", statusClass: "text-[#75777e] border border-[#75777e]", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuAKxw7By4qjATGTmib8dpf6bLN9IYm-gQMfh-91hD5Gig79h9_GnhudW619X7zS22mKuJV1AoCSrQ0KEYAnWWI4oVOQ6EQR6F4sm0KGQPGc92lLO-IFRQLEU-O2FlU9ICSn9zneNFUZPrh4cGDprDvD0dvYUpJpX86kFHuqr2E9NtVqEx9erHZm4y38OCkp3us8K3PZM3iv3MBkKlnQh4u19C29m2_-d5pOtqOKRjgWKxYRsZr6lsVVCrqjeqlFAr5M8GqH2Tkqxg" },
];
      ...
      <main className="max-w-[1280px] mx-auto px-6 md:px-20 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-20 h-auto md:h-[400px]">
          <div className="md:col-span-2 group relative overflow-hidden rounded-xl border border-[#c5c6cd] hover:border-[#006399] transition-all">
            ...
            <Image src="https://lh3.googleusercontent.com/aida-public/AB6AXuBozgxt9292pqrTw-Fo9WO_HEabwhrBjsZUUF1Mx2fe14gls9ur8yxd3q_1jfXqEy0_2kMr045bfrLSSz-IU-EneUIo2fQ63Uvo4NYioNmfQMoAv8HVBd8Cuo5tWjOQvbCSZISiYFOvlg444CJWVnTDGpEX0AHrGpyJgC-d2ZBm8_DDTlOIgkHV382onaB6TaufnurMQDJq-E1Cn8T4vKD5sHYzh_2aCzsjGD5oje7EYfwmysmKHETykhnRJS9gbVY36PgolUZYBw" alt="Hockey Sticks" fill className="object-cover transition-transform duration-700 group-hover:scale-105" />
        ...
        <section className="mb-20 bg-black text-white rounded-xl overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="p-8 md:p-16 flex flex-col justify-center">
              ...
              <h2 className="font-montserrat text-[48px] font-extrabold mb-4">CCM Authentic Collection</h2>
              <p className="font-inter text-lg text-white/70 mb-12">
                We carry a full range of CCM professional equipment. Engineered for the fastest game on earth, CCM gear is the gold standard for NHL stars.
              </p>
            ...
            <div className="relative h-64 md:h-full min-h-[400px]">
              <Image
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuADAb3eHIh7aRAaGJOaQuh7EWlJHLBah1ta3U4kuyrhWs-1FxKE9beUjvZ6PTPgxoOz6olYqK7LQWZjGKfrnulr32Udr0w80NDrKEiInCC6cJkt7Y8Zh5p7fqO2ng1hw-MsI1KGHZ5niaxPPCphIC_XJCvu4x_QBWS2olpYN2w4eROnkBhEgmuK3F-84FgJC1v-M8DXFZiILD43u0WaORFN_FdFXpWTGWlnlCVBZ657URcL1mDqd_cNmrhiAblFqFsIrXsbwa8pbw"
                alt="CCM equipment"
                fill
